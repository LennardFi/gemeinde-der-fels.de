                ...
                body: {
                    ...
                    data: {
                        ...
                        entries: users.map((u) => ({
                            ...
                            flags: {
                                Admin: u.AdminFlag,
                                ManageCalendar: u.ManageCalendarFlag,
                                ManageNews: u.ManageNewsFlag,
                                ManageRooms: u.ManageRoomsFlag,
                                ManageSermons: u.ManageSermonsFlag,
                                ManageUser: u.ManageUserFlag,
                            },
                            id: u.id,
                            userName: u.userName,
                        })),
