        ...
        <PageContainer title="Werte und Vision" themeColor="primary">
            <Paper breakpoint="small" noBackgroundColor>
                ...
                <p>
                    ...
                    <br />
                    wir bejüngern und befähigen Menschen,
                    <br />
                    durch die Kraft des{" "}
            ...
            <Paper breakpoint="small" noBackgroundColor>
                ...
                >
                    <summary onClick={onToggleMainValue(0)}>
                        <FaAngleRight
                            ...
                            style={{
                                rotate:
                                    expandedMainValue !== 0 ? "0deg" : "90deg",
                            }}
                        />{" "}
                        Hingegeben
                    </summary>
                ...
                >
                    <summary onClick={onToggleMainValue(1)}>
                        <FaAngleRight
                            ...
                            style={{
                                rotate:
                                    expandedMainValue !== 1 ? "0deg" : "90deg",
                            }}
                        />{" "}
                        Familiär
                    </summary>
                ...
                >
                    <summary onClick={onToggleMainValue(2)}>
                        <FaAngleRight
                            ...
                            style={{
                                rotate:
                                    expandedMainValue !== 2 ? "0deg" : "90deg",
                            }}
                        />{" "}
                ...
                >
                    <summary onClick={onToggleMainValue(3)}>
                        <FaAngleRight
                            ...
                            style={{
                                rotate:
                                    expandedMainValue !== 3 ? "0deg" : "90deg",
                            }}
                        />{" "}
                        Wiederherstellend
                    </summary>
                ...
                >
                    <summary onClick={onToggleMainValue(4)}>
                        <FaAngleRight
                            ...
                            style={{
                                rotate:
                                    expandedMainValue !== 4 ? "0deg" : "90deg",
                            }}
                        />{" "}
                        Dienend
                    </summary>
                ...
                >
                    <summary onClick={onToggleMainValue(5)}>
                        <FaAngleRight
                            ...
                            style={{
                                rotate:
                                    expandedMainValue !== 5 ? "0deg" : "90deg",
                            }}
                        />{" "}
                ...
                {/* <ul>
                    <li onClick={() => setExpandedValue(2)}>
                        In Jüngerschaft gehen
                    </li>
                    <li onClick={() => setExpandedValue(3)}>
                        Wiederherstellend
                    </li>
                    <li onClick={() => setExpandedValue(4)}>Dienend</li>
                    <li onClick={() => setExpandedValue(5)}>
                        In Leiterschaft bringen
                    </li>
                </ul> */}
            </Paper>
